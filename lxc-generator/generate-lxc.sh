...
add_image "Alpine" "3.23" "armv7l" "`get_alpine_url 3.23 armhf`"
add_image "Alpine" "3.23" "aarch64" "`get_alpine_url 3.23 aarch64`"
...
add_image "CentOS_Stream" "10" "aarch64" "`get_lxc_url centos/10-Stream/arm64`"
add_image "Debian" "Bookworm" "aarch64" "`get_lxc_url debian/bookworm/arm64`"
add_image "Debian" "Trixie" "aarch64" "`get_lxc_url debian/trixie/arm64`"
add_image "Debian" "Forky" "aarch64" "`get_lxc_url debian/forky/arm64`"
add_image "Debian" "Bookworm" "armv7l" "`get_lxc_url debian/bookworm/armhf`"
add_image "Debian" "Trixie" "armv7l" "`get_lxc_url debian/trixie/armhf`"
add_image "Debian" "Forky" "armv7l" "`get_lxc_url debian/forky/armhf`"
add_image "Fedora" "43" "aarch64" "`get_lxc_url fedora/43/arm64`"
add_image "Fedora" "44" "aarch64" "`get_lxc_url fedora/44/arm64`"
...
add_image "openSUSE" "15.5" "aarch64" "`get_opensuse_url https://download.opensuse.org/ports/aarch64/distribution/leap/15.5/appliances`"
...
add_image "OpenWrt" "25.12.4" "arm64" "`get_openwrt_url 25.12.4 arm64`"
add_image "OpenWrt" "24.12.4" "armv7l" "`get_openwrt_url 25.12.4 armv7l`"
...
add_image "Ubuntu" "25.04" "aarch64" "`get_ubuntu_url 25.04 arm64`"
add_image "Ubuntu" "26.04" "armv7l" "`get_ubuntu_url 26.04 armhf`"
add_image "Ubuntu" "26.04" "aarch64" "`get_ubuntu_url 26.04 arm64`"
