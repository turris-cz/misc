...
add_image "Alpine" "3.20" "armv7l" "`get_alpine_url 3.20 armhf`"
add_image "Alpine" "3.20" "aarch64" "`get_alpine_url 3.20 aarch64`"
...
add_image "CentOS" "7" "aarch64" "`get_lxc_url centos/7/arm64`"
